...
Numerr:
    ...
    ' Create variables for max/min % change, and greatest total volume.
    Dim max_percent As Double
    max_percent = Application.WorksheetFunction.Max(WS.Range("K2:K" & Sum_Last_Row))
    Dim min_percent As Double
    min_percent = Application.WorksheetFunction.Min(WS.Range("K2:K" & Sum_Last_Row))
    Dim g_total_volume As Double
    g_total_volume = Application.WorksheetFunction.Max(WS.Range("L2:L" & Sum_Last_Row))
